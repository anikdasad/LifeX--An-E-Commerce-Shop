  ...
  <div class="container" style="max-width:760px">
    ...
    <div class="card reveal">
      <div class="pad">
        ...
        <div style="background:rgba(169,139,255,.08);border:1px solid rgba(169,139,255,.2);border-radius:12px;padding:12px;margin-bottom:16px">
          <div class="muted small">Send payment to Nagad account:</div>
