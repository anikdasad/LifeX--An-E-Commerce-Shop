  ...
  <div class="container" style="max-width:760px">
    ...
    <div class="card reveal">
      <div class="pad">
        ...
        <div style="background:rgba(255,193,7,.08);border:1px solid rgba(255,193,7,.2);border-radius:12px;padding:12px;margin-bottom:16px">
          <div class="muted small">Bank Transfer Details:</div>
          <div style="margin-top:8px;font-size:13px;line-height:1.6">
            <div><strong>Account Number:</strong> 1234567890</div>
            <div><strong>Bank Name:</strong> LifeX Bank</div>
            <div><strong>Branch:</strong> Main Branch</div>
            <div style="margin-top:8px"><strong>Amount:</strong> ৳<?= number_format(cart_total($pdo) + (float)$pending['checkout']['shipping_cost'], 2) ?></div>
          </div>
          <div class="muted small" style="margin-top:8px">Please transfer the exact amount and reply with transaction ID.</div>
        </div>
